...
extern void FSYMBOL(bn_int1024_and)(bn_int1024_t r, bn_int1024_t a, bn_int1024_t b);
extern void FSYMBOL(bn_int1024_or)(bn_int1024_t r, bn_int1024_t a, bn_int1024_t b);
extern void FSYMBOL(bn_int1024_xor)(bn_int1024_t r, bn_int1024_t a, bn_int1024_t b);
extern void FSYMBOL(bn_int1024_not)(bn_int1024_t r, bn_int1024_t n);
extern void FSYMBOL(bn_int1024_add)(bn_int1024_t r, const bn_int1024_t a,
		const bn_int1024_t b);
extern void FSYMBOL(bn_int1024_sub)(bn_int1024_t r, const bn_int1024_t a,
		const bn_int1024_t b);
extern void FSYMBOL(bn_int1024_mul)(bn_int1024_t r, const bn_int1024_t a,
		const bn_int1024_t b);
...
extern void FSYMBOL(bn_uint1024_and)(bn_uint1024_t r, bn_uint1024_t a, bn_uint1024_t b);
extern void FSYMBOL(bn_uint1024_or)(bn_uint1024_t r, bn_uint1024_t a, bn_uint1024_t b);
extern void FSYMBOL(bn_uint1024_xor)(bn_uint1024_t r, bn_uint1024_t a, bn_uint1024_t b);
extern void FSYMBOL(bn_uint1024_not)(bn_uint1024_t r, bn_uint1024_t n);
extern uint32 FSYMBOL(bn_uint1024_add)(bn_uint1024_t r, const bn_uint1024_t a,
		const bn_uint1024_t b);
extern uint32 FSYMBOL(bn_uint1024_add_1)(bn_uint1024_t r, const bn_uint1024_t a, uint32 b);
extern void FSYMBOL(bn_uint1024_sub)(bn_uint1024_t r, const bn_uint1024_t a,
		const bn_uint1024_t b);
extern void FSYMBOL(bn_uint1024_sub_1)(bn_uint1024_t r, const bn_uint1024_t a, uint32 b);
extern uint32 FSYMBOL(bn_uint1024_mul)(bn_uint1024_t r, const bn_uint1024_t a,
		const bn_uint1024_t b);
extern uint32 FSYMBOL(bn_uint1024_mul_1)(bn_uint1024_t r, const bn_uint1024_t a, uint32 b);
