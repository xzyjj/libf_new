...
#define JSON_ERR_OBJECT_START 4
#undef JSON_ERR_OBJECT_VALUE
#define JSON_ERR_OBJECT_VALUE 5
#undef JSON_ERR_OBJECT_END
#define JSON_ERR_OBJECT_END 6
#undef JSON_ERR_OBJECT_STRING
#define JSON_ERR_OBJECT_STRING 7
#undef JSON_ERR_OBJECT_NUMBER
#define JSON_ERR_OBJECT_NUMBER 8
#undef JSON_ERR_OBJECT_NULL
#define JSON_ERR_OBJECT_NULL 9
#undef JSON_ERR_OBJECT_TRUE
#define JSON_ERR_OBJECT_TRUE 10
#undef JSON_ERR_OBJECT_FALSE
#define JSON_ERR_OBJECT_FALSE 11

#undef JSON_ERR_ARRAY_TOKEN
#define JSON_ERR_ARRAY_TOKEN 12
#undef JSON_ERR_ARRAY_START
#define JSON_ERR_ARRAY_START 13
#undef JSON_ERR_ARRAY_END
#define JSON_ERR_ARRAY_END 14
#undef JSON_ERR_ARRAY_STRING
#define JSON_ERR_ARRAY_STRING 15
#undef JSON_ERR_ARRAY_NUMBER
#define JSON_ERR_ARRAY_NUMBER 16
#undef JSON_ERR_ARRAY_NULL
#define JSON_ERR_ARRAY_NULL 17
#undef JSON_ERR_ARRAY_TRUE
#define JSON_ERR_ARRAY_TRUE 18
#undef JSON_ERR_ARRAY_FALSE
#define JSON_ERR_ARRAY_FALSE 19

#undef JSON_ERR_COMMENT
#define JSON_ERR_COMMENT 20
