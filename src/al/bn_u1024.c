...
/* @func: bn_uint1024_bits - get the bit length of big number
* @param1: bn_uint1024_t # number
* @return: uint32        # bits length
*/
uint32 FSYMBOL(bn_uint1024_bits)(const bn_uint1024_t n) {
...
void FSYMBOL(bn_uint1024_move)(bn_uint1024_t t, const bn_uint1024_t s) {
	XSYMBOL(memcpy)(t, s, sizeof(uint32) * BN_1024_SIZE);
	t[BN_1024_SIZE] = 0;
} /* end */
...
* @return: void
*/
void FSYMBOL(bn_uint1024_and)(bn_uint1024_t r,
...
* @return: void
*/
void FSYMBOL(bn_uint1024_or)(bn_uint1024_t r,
		const bn_uint1024_t a, const bn_uint1024_t b) {
	bn_uint1024_t rr;
	FSYMBOL(bn_uint1024_zero)(rr);
...
* @return: void
*/
void FSYMBOL(bn_uint1024_xor)(bn_uint1024_t r,
		const bn_uint1024_t a, const bn_uint1024_t b) {
	bn_uint1024_t rr;
	FSYMBOL(bn_uint1024_zero)(rr);
...
* @return: void
*/
void FSYMBOL(bn_uint1024_not)(bn_uint1024_t r,
...
*/
uint32 FSYMBOL(bn_uint1024_add)(bn_uint1024_t r,
		const bn_uint1024_t a, const bn_uint1024_t b) {
	bn_uint1024_t rr;
...
* @return: uint32              # carry overflow
*/
uint32 FSYMBOL(bn_uint1024_add_1)(bn_uint1024_t r,
...
* @return: void
*/
void FSYMBOL(bn_uint1024_sub)(bn_uint1024_t r,
		const bn_uint1024_t a, const bn_uint1024_t b) {
	bn_uint1024_t rr;
	FSYMBOL(bn_uint1024_move)(rr, a);
...
* @return: void
*/
void FSYMBOL(bn_uint1024_sub_1)(bn_uint1024_t r,
		const bn_uint1024_t a, uint32 b) {
	bn_uint1024_t rr;
	FSYMBOL(bn_uint1024_move)(rr, a);
...
* @return: uint32              # carry overflow
*/
uint32 FSYMBOL(bn_uint1024_mul)(bn_uint1024_t r,
		const bn_uint1024_t a, const bn_uint1024_t b) {
	bn_uint1024_t rr;
	FSYMBOL(bn_uint1024_zero)(rr);
...
* @return: uint32              # carry overflow
*/
uint32 FSYMBOL(bn_uint1024_mul_1)(bn_uint1024_t r,
		const bn_uint1024_t a, uint32 b) {
	bn_uint1024_t rr;
	FSYMBOL(bn_uint1024_zero)(rr);
...
void FSYMBOL(bn_uint1024_div)(bn_uint1024_t quo, bn_uint1024_t rem,
		const bn_uint1024_t a, const bn_uint1024_t b) {
	bn_uint1024_t rquo, rrem, sh_b, pow2;
	...
	uint32 sh = 0;
	uint32 psh = FSYMBOL(bn_uint1024_bits)(rrem)
		- FSYMBOL(bn_uint1024_bits)(sh_b);
	if (psh > 15) {
		FSYMBOL(bn_uint1024_zero)(pow2);
		pow2[psh / 32] = 1U << (psh % 32);
		FSYMBOL(bn_uint1024_mul)(sh_b, sh_b, pow2);
		sh = psh;
	}
