/* bn_u512.c - big number calculation (512bit) implementations */
...
/* @func: bn_uint512_zero - big number init
...
void FSYMBOL(bn_uint512_move)(bn_uint512_t t, const bn_uint512_t s) {
	XSYMBOL(memcpy)(t, s, sizeof(uint32) * (BN_512_SIZE + 1));
} /* end */

/* @func: bn_uint512_cmp - big number compare
* @param1: bn_uint512_t # number (a)
* @param2: bn_uint512_t # number (b)
...
/* @func: bn_uint513_cmp - big number compare
* @param1: bn_uint512_t # number (a)
* @param2: bn_uint512_t # number (b)
* @return: int32        # 0: a==b, 1: a>b, -1: a<b
*/
...
/* @func: bn_uint512_cmp_1 - big number compare
* @param1: bn_uint512_t # number (a)
...
/* @func: bn_uint512_lsh - shift big numbers left 1bit
* @param1: bn_uint512_t # number
* @return: void
*/
void FSYMBOL(bn_uint512_lsh)(bn_uint512_t n) {
	uint32 carry = 0;
	for (int32 i = 0; i < BN_512_SIZE; i++) {
		uint32 tmp = n[i] >> 31;
		n[i] = (n[i] << 1) | carry;
		carry = tmp;
	}
...
/* @func: bn_uint513_lsh - shift big numbers left 1bit
* @param1: bn_uint512_t # number
* @return: void
*/
void FSYMBOL(bn_uint513_lsh)(bn_uint512_t n) {
	uint32 carry = 0;
	for (int32 i = 0; i < (BN_512_SIZE + 1); i++) {
		uint32 tmp = n[i] >> 31;
		n[i] = (n[i] << 1) | carry;
		carry = tmp;
	}
...
/* @func: bn_uint512_rsh - shift big numbers right 1bit
* @param1: bn_uint512_t # number
* @return: void
*/
...
/* @func: bn_uint513_rsh - shift big numbers right 1bit
* @param1: bn_uint512_t # number
* @return: void
*/
...
/* @func: bn_uint512_and - big number and operation
* @param1: bn_uint512_t       # result
...
void FSYMBOL(bn_uint512_and)(bn_uint512_t r, bn_uint512_t a, bn_uint512_t b) {
	...
	FSYMBOL(bn_uint512_move)(r, rr);
} /* end */

/* @func: bn_uint512_or - big number or operation
* @param1: bn_uint512_t       # result
* @param2: const bn_uint512_t # number
* @param3: const bn_uint512_t # number
* @return: void
...
/* @func: bn_uint512_xor - big number xor operation
* @param1: bn_uint512_t       # result
* @param2: const bn_uint512_t # number
* @param3: const bn_uint512_t # number
* @return: void
...
/* @func: bn_uint512_not - big number not operation
* @param1: bn_uint512_t       # result
* @param2: const bn_uint512_t # number
* @return: void
*/
...
/* @func: bn_uint512_add - big number addition
...
uint32 FSYMBOL(bn_uint512_add)(bn_uint512_t r, const bn_uint512_t a,
	...
	if (!FSYMBOL(bn_uint512_cmp_1)(b, 0)) {
		FSYMBOL(bn_uint512_move)(r, rr);
		return 0;
	}
...
/* @func: bn_uint512_add_1 - big number addition
* @param1: bn_uint512_t       # sum
* @param2: const bn_uint512_t # addend
...
/* @func: bn_uint512_sub - big number subtraction
* @param1: bn_uint512_t       # difference
* @param2: const bn_uint512_t # minuend
...
void FSYMBOL(bn_uint512_sub)(bn_uint512_t r, const bn_uint512_t a,
	...
	if (!(FSYMBOL(bn_uint512_cmp_1)(a, 0)
			&& FSYMBOL(bn_uint512_cmp_1)(b, 0))) {
		FSYMBOL(bn_uint512_move)(r, rr);
		return;
	}
...
/* @func: bn_uint512_sub_1 - big number subtraction
* @param1: bn_uint512_t       # difference
* @param2: const bn_uint512_t # minuend
...
void FSYMBOL(bn_uint512_sub_1)(bn_uint512_t r, const bn_uint512_t a, uint32 b) {
	...
	if (!(FSYMBOL(bn_uint512_cmp_1)(a, 0) && b)) {
		FSYMBOL(bn_uint512_move)(r, rr);
		return;
	}
...
/* @func: bn_uint512_mul - big number multiplication
* @param1: bn_uint512_t       # product
* @param3: const bn_uint512_t # multiplicand
...
/* @func: bn_uint512_mul_1 - big number multiplication
* @param1: bn_uint512_t       # product
* @param3: const bn_uint512_t # multiplicand
...
/* @func: bn_uint512_div - big number division
* @param1: bn_uint512_t       # quotient
* @param2: bn_uint512_t       # remainder
* @param3: const bn_uint512_t # dividend
* @param4: const bn_uint512_t # divisor
* @return: void
*/
void FSYMBOL(bn_uint512_div)(bn_uint512_t quo, bn_uint512_t rem,
	...
	FSYMBOL(bn_uint512_zero)(quo);

	if (FSYMBOL(bn_uint512_cmp)(rrem, sh_b) < 0)
		return;
	if (!(FSYMBOL(bn_uint512_cmp_1)(rrem, 0)
			&& FSYMBOL(bn_uint512_cmp_1)(sh_b, 0))) {
		FSYMBOL(bn_uint512_zero)(rem);
		return;
	}
	...
	FSYMBOL(bn_uint512_zero)(rquo);
	for (; sh > 0; sh--) {
		FSYMBOL(bn_uint513_rsh)(sh_b);
		FSYMBOL(bn_uint513_lsh)(rquo);
		if (FSYMBOL(bn_uint513_cmp)(rrem, sh_b) >= 0) {
			FSYMBOL(bn_uint512_sub)(rrem, rrem, sh_b);
			rquo[0] |= 1;
		}
	}

	FSYMBOL(bn_uint512_move)(quo, rquo);
	FSYMBOL(bn_uint512_move)(rem, rrem);
} /* end */

/* @func: bn_uint512_strtonum - string convert big number
* @param1: bn_uint512_t # number
...
void FSYMBOL(bn_uint512_strtonum)(bn_uint512_t t, const char *s, char **e,
	...
	for (int32 d = 0; *s != '\0'; s++) {
		...
		FSYMBOL(bn_uint512_mul_1)(t, t, b);
		FSYMBOL(bn_uint512_add_1)(t, t, d);
	}
...
/* @func: bn_uint512_numtostr - big number to string
* @param1: char *             # string buffer
* @param2: const bn_uint512_t # number
* @return: void
*/
void FSYMBOL(bn_uint512_numtostr)(char *buf, const bn_uint512_t n) {
	bn_uint512_t quo, rem, b;
	FSYMBOL(bn_uint512_move)(quo, n);
	FSYMBOL(bn_uint512_zero)(b);
	b[0] = 10;

	int32 pos = 0;
	do {
		FSYMBOL(bn_uint512_div)(quo, rem, quo, b);
		int32 k = pos;
	...
	} while (FSYMBOL(bn_uint512_cmp_1)(quo, 0));
	buf[pos] = '\0';
...
/* @func: bn_uint512_numtostr_hex - big number to string (hexadecimal)
* @param1: char *             # string buffer
* @param2: const bn_uint512_t # number
* @return: void
*/
void FSYMBOL(bn_uint512_numtostr_hex)(char *buf, const bn_uint512_t n) {
	bn_uint512_t quo, rem, b;
	FSYMBOL(bn_uint512_move)(quo, n);
	FSYMBOL(bn_uint512_zero)(b);
	b[0] = 16;
