...
/* @func: bn_uint8192_bits - get the bit length of big number
* @param1: bn_uint8192_t # number
* @return: uint32        # bits length
*/
uint32 FSYMBOL(bn_uint8192_bits)(const bn_uint8192_t n) {
...
* @return: void
*/
void FSYMBOL(bn_uint8192_and)(bn_uint8192_t r,
...
* @return: void
*/
void FSYMBOL(bn_uint8192_or)(bn_uint8192_t r,
		const bn_uint8192_t a, const bn_uint8192_t b) {
	bn_uint8192_t rr;
	FSYMBOL(bn_uint8192_zero)(rr);
...
* @return: void
*/
void FSYMBOL(bn_uint8192_xor)(bn_uint8192_t r,
		const bn_uint8192_t a, const bn_uint8192_t b) {
	bn_uint8192_t rr;
	FSYMBOL(bn_uint8192_zero)(rr);
...
* @return: void
*/
void FSYMBOL(bn_uint8192_not)(bn_uint8192_t r,
...
*/
uint32 FSYMBOL(bn_uint8192_add)(bn_uint8192_t r,
		const bn_uint8192_t a, const bn_uint8192_t b) {
	bn_uint8192_t rr;
...
* @return: uint32              # carry overflow
*/
uint32 FSYMBOL(bn_uint8192_add_1)(bn_uint8192_t r,
...
* @return: void
*/
void FSYMBOL(bn_uint8192_sub)(bn_uint8192_t r,
		const bn_uint8192_t a, const bn_uint8192_t b) {
	bn_uint8192_t rr;
	FSYMBOL(bn_uint8192_move)(rr, a);
...
* @return: void
*/
void FSYMBOL(bn_uint8192_sub_1)(bn_uint8192_t r,
		const bn_uint8192_t a, uint32 b) {
	bn_uint8192_t rr;
	FSYMBOL(bn_uint8192_move)(rr, a);
...
* @return: uint32              # carry overflow
*/
uint32 FSYMBOL(bn_uint8192_mul)(bn_uint8192_t r,
		const bn_uint8192_t a, const bn_uint8192_t b) {
	bn_uint8192_t rr;
	FSYMBOL(bn_uint8192_zero)(rr);
...
* @return: uint32              # carry overflow
*/
uint32 FSYMBOL(bn_uint8192_mul_1)(bn_uint8192_t r,
		const bn_uint8192_t a, uint32 b) {
	bn_uint8192_t rr;
	FSYMBOL(bn_uint8192_zero)(rr);
...
void FSYMBOL(bn_uint8192_div)(bn_uint8192_t quo, bn_uint8192_t rem,
		const bn_uint8192_t a, const bn_uint8192_t b) {
	bn_uint8192_t rquo, rrem, sh_b, pow2;
	...
	uint32 sh = 0;
	uint32 psh = FSYMBOL(bn_uint8192_bits)(rrem)
		- FSYMBOL(bn_uint8192_bits)(sh_b);
	if (psh > 15) {
		FSYMBOL(bn_uint8192_zero)(pow2);
		pow2[psh / 32] = 1U << (psh % 32);
		FSYMBOL(bn_uint8192_mul)(sh_b, sh_b, pow2);
		sh = psh;
	}
