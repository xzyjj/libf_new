...
int main(void) {
	...
	FSYMBOL(bn_int1024_strtonum)(a_in,
		"104315357185812371972519629412615562208764248274552873578875083433132042805390"
		, NULL, 10);
	FSYMBOL(bn_int1024_strtonum)(b_in,
		"81920555950439335876759437530879201210802448154855323910250908339242413182426"
		, NULL, 10);
